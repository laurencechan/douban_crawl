    ...
    def get_image(self, html):
        ...
        for i in imgurl_list:
            ...
            with open(self.get_route() + "//%s" % i[-15:], "wb") as f:
                f.write(requests.get(i, headers=self.header_referer_change()).content)
                # https://movie.douban.com/celebrity/1348382/photos/?type=C&start=0&sortby=vote&size=a&subtype=a
